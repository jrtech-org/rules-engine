...
public class MapLocalDateValueWriter implements ObjectAttributeWriter<Map<String, Object>, String> {
    ...
    public boolean write(Map<String, Object> object, String attributeName, String value) {
        try {
            LocalDate objectValue = (LocalDate) DateTimeFormatter.ISO_LOCAL_DATE.parse(value);
