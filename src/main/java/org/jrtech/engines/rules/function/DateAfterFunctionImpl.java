...
/**
 * The class <code>DateAfterFunctionImpl</code> is used for comparing date value
 * as string in the following date formats:
 * <li>ISO Date</li>
 * <li>ISO Datetime</li>
 ...
 */
public class DateAfterFunctionImpl extends AbstractDateFunctionImpl {
