...
/**
 * The class <code>TimeBeforeFunctionImpl</code> is used for comparing time
 * value as string in the following time formats:
 * <li>HH:mm:ss</li>
 * <li>HH:mm:ss.SSS</li>
 * <li>HHmmss</li>
 * <li>HHmmss.SSS</li> <br>
 ...
 */
public class TimeBeforeFunctionImpl extends AbstractTimeFunctionImpl {
