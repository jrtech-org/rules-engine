...
public class BooleanEqualsFunctionImpl extends AbstractInternalFunctionImpl {

    private static final long serialVersionUID = 5468333431625390228L;
    ...
    public boolean match(Object actualValue, Object expectedValue) {
        if (actualValue == null && expectedValue == null) {
            ...
            return ((Boolean) actualValue).equals((Boolean) expectedValue);
        }
