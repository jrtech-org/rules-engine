...
public class DateConditionalAttribute extends ConditionalAttribute {
    ...
    public DateConditionalAttribute(String name, String value) {
        this(name, value, false, Owner.SOURCE);
    }

    public DateConditionalAttribute(String name, String value, boolean negate) {
        this(name, value, negate, Owner.SOURCE);
    }

    public DateConditionalAttribute(String name, String value, boolean negate, Owner owner) {
        this(name, value, negate, owner, "");
    }

    public DateConditionalAttribute(String name, String value, boolean negate, String operatorFunction) {
        this(name, value, negate, Owner.SOURCE, operatorFunction);
    }

    public DateConditionalAttribute(String name, String value, boolean negate, Owner owner, String operatorFunction) {
